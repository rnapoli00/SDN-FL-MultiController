...
print(os.getcwd())
df_processed = read_csv_files("../../Desktop/project/new_dataset/new_client1.csv")
df_processed
...
client1 = FlowerClient(model_dnn, trainloader, valloader, loss_fun, optimizer, epoch=5)
